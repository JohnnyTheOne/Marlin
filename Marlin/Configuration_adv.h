...
//#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLER_FAN_PIN HEATER_2_PIN        // Set a custom pin for the controller fan
...
#define HOMING_BACKOFF_POST_MM { 1, 1, 5 }  // (mm) Backoff from endstops after homing
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 20*60, 2*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #define POWER_LOSS_RECOVERY
    ...
    #define POWER_LOSS_PIN       PI11 // Pin to detect power loss. Set to -1 to disable default pin on boards without module.
 ...
 */
  ...
  #define MMU2_SERIAL_PORT 6 //Serial wifi
   ...
   */
    ...
    #define MMU2_CAN_LOAD_RETRACT   2.0   // (mm) Keep under the distance between Load Sequence values
